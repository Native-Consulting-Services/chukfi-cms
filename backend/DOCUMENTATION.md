...
replace native-consult.io/chukfi-cms => /path/to/chukfi-cms/backend
...
```go
import database "native-consult.io/chukfi-cms/database/mysql"
...
```go
import helper "native-consult.io/chukfi-cms/database/helper"
...
```go
import "native-consult.io/chukfi-cms/database/schema"
...
```go
import "native-consult.io/chukfi-cms/src/httpresponder"
...
```go
import "native-consult.io/chukfi-cms/src/lib/permissions"
...
```go
import generate_types "native-consult.io/chukfi-cms/cmd/generate-types"
...
```go
import usercache "native-consult.io/chukfi-cms/src/lib/cache/user"
...
```go
import "native-consult.io/chukfi-cms/src/lib/schemaregistry"
...
```go
import "native-consult.io/chukfi-cms/src/lib/detection"
...
```go
import "native-consult.io/chukfi-cms/src/lib/astparser"
